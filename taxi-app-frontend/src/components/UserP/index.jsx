  ...
  return (
    ...
    {Loading ? (
      ...
      <div className="left-container">
        ...
        <button type="submit" className="change-profile-button">Change profile</button>
        <button className="change-profile-button" onClick={navigateEditProfile}>Edit Profile</button>
        <button className="change-profile-button" onClick={navigateSupport}>Support</button>
        </div>
